...
namespace PineBT
{
    ...
    public class RandomSelector : Composite
    {
        ...
        /// </summary>
        public RandomSelector(string name) : this(name, new List<Node>())
        {}

        /// <summary>
        /// Creates a RandomSelector with a custom name and a provided children node list.
        /// </summary>
        public RandomSelector(string name, List<Node> nodes) : base(name, nodes)
        {}
